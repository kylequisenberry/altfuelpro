...
interface StationsFilterModalProps {
  visible: boolean;
  onClose: () => void;
  filters: StationFilters;
  onApplyFilters: (filters: StationFilters) => void;
}

export const StationsFilterModal: React.FC<StationsFilterModalProps> = ({
  visible,
  onClose,
  filters,
  onApplyFilters,
        ...
        <View style={styles.container}>
          <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
              ...
              {/* Fuel Type Section */}
              <Text style={[styles.sectionTitle, { marginTop: 24 }]}>Fuel Type</Text>
